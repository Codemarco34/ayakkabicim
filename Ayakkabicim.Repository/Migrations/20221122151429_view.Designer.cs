...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ayakkabicim.Core.Models.CompanyBayi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CompanyBayi");
                });

            modelBuilder.Entity("Ayakkabicim.Core.Models.CompanyFirma", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FirmaIdId");

                    b.ToTable("CompanyFirma");
                });

            modelBuilder.Entity("Ayakkabicim.Core.Models.CompanySube", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ayakkabicim.Core.Models.Products", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            Code = "123AS",
                            CreateDate = new DateTime(2022, 11, 22, 18, 14, 28, 978, DateTimeKind.Local).AddTicks(9932),
                            ExpirationDate = new DateTime(2022, 11, 22, 18, 14, 28, 978, DateTimeKind.Local).AddTicks(9922),
                            ...
                            UpdateDate = new DateTime(2022, 11, 22, 18, 14, 28, 978, DateTimeKind.Local).AddTicks(9934)
                        });
                });
            ...
            modelBuilder.Entity("Ayakkabicim.Core.Models.CompanyBayi", b =>
                {
                    b.HasOne("Ayakkabicim.Core.Models.CompanyBayi", "BayiId")
                        .WithMany()
                        .HasForeignKey("BayiIdId");
            ...
            modelBuilder.Entity("Ayakkabicim.Core.Models.CompanyFirma", b =>
                {
                    b.HasOne("Ayakkabicim.Core.Models.CompanyFirma", "FirmaId")
                        .WithMany()
                        .HasForeignKey("FirmaIdId");

                    b.Navigation("FirmaId");
                });

            modelBuilder.Entity("Ayakkabicim.Core.Models.CompanySube", b =>
                {
                    b.HasOne("Ayakkabicim.Core.Models.CompanySube", "SubeId")
                        .WithMany()
                        .HasForeignKey("SubeIdId");
